...
export default function PrivacyPolicyPage() {
  return (
    <main className={styles.container}>
      ...
      <p>
        (
        <a href="https://just-swim.kr" target="_blank" rel="noopener noreferrer">
          https://just-swim.kr
        </a>{' '}
        이하 ‘Just Swim’)은 ⌜개인정보보호법⌟ 제 30조에 따라 정보주체(이용자)의
        개인정보를 보호하고 이와 관련된 고충을 신속하고 원활하게 처리할 수 있도록
        하기 위해 다음과 같이 개인정보 처리 방침을 수립·공개 합니다.
      </p>
      ...
      <h2>제 4조 ~ 제 7조</h2>
      <p>
        내용이 길어져 생략했습니다. 실제 구현 시 모든 조항을 그대로 JSX로 옮기면
        됩니다.
      </p>
